...
A direção tera a responsabilidade de controlar a rota.Ela oferece os seguintes atributos:
1) Valor de direção com valores possíveis norte(c), sul(b), leste(d) e oeste(e).
2) Metodo girar_a_direita
3) Metodo girar_a_esqueda
